...
import { PrismaClientKnownRequestError as E1 } from '@prisma-kb/client/runtime/client'
import { PrismaClientKnownRequestError as E2 } from '@prisma-kb/client/runtime/client.js'
